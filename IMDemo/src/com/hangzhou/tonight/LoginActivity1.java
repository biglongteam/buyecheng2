...
import com.hangzhou.tonight.util.LoginTask;
 ...
 * @author shimiso
 */
public class LoginActivity1 extends ActivitySupport {
	...
	protected void init() {
		...
		if (loginConfig.isAutoLogin()) {
			LoginTask loginTask = new LoginTask(LoginActivity1.this, loginConfig);
			loginTask.execute();
		}
		...
		btn_login.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (checkData() && validateInternet()) {
					...
					LoginTask loginTask = new LoginTask(LoginActivity1.this,
							loginConfig);
				    loginTask.execute();
				}
			}
					...
					.setPositiveButton("确定",
							new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									loginConfig.setXmppServiceName("115.29.246.139");
