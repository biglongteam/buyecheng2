...
public class RoomChatActivity extends BaseRoomActivity implements
...
//					 }
	...
	public void onClick(View v) {
		...
		int viewId = v.getId();
		if(viewId== R.id.edit_user_comment){
			if (layout_more.getVisibility() == View.VISIBLE) {
				layout_add.setVisibility(View.GONE);
				layout_emo.setVisibility(View.GONE);
				layout_more.setVisibility(View.GONE);
			}
		}else if(viewId== R.id.btn_chat_emo){
		...
		}else if(viewId== R.id.btn_chat_add){
			if (layout_more.getVisibility() == View.GONE) {
		...
		}else if(viewId== R.id.btn_chat_voice){
			...
			hideSoftInputView();
		}else if(viewId== R.id.btn_chat_keyboard){
			showEditState(false);
		}else if(viewId== R.id.tv_camera){
			selectImageFromCamera();
		}else if(viewId== R.id.tv_picture){
