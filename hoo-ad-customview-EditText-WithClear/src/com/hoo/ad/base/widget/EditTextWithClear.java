...
public class EditTextWithClear extends EditText {
	...
	private void init() {
		if(null == mRight){ mRight = context.getResources().getDrawable(R.drawable.widget_edittext_withclear);}
		setDrawable();
		// 增加文本监听器.
	...
	@Override public void setCompoundDrawables(Drawable left, Drawable top,Drawable right, Drawable bottom) {
