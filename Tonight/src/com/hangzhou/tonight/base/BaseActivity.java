...
import com.hangzhou.tonight.util.NetWorkUtils;
...
public abstract class BaseActivity extends FragmentActivity {
	...
	protected List<AsyncTask<Void, Void, String>> mAsyncTasks2 = new ArrayList<AsyncTask<Void, Void, String>>();
	...
	protected void putAsyncTask2(AsyncTask<Void, Void, String> asyncTask) {
		mAsyncTasks2.add(asyncTask.execute());
	}
	...
	protected void clearAsyncTask2() {
		Iterator<AsyncTask<Void, Void, String>> iterator = mAsyncTasks2
				.iterator();
		while (iterator.hasNext()) {
