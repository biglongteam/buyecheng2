		...
		new AsyncTask<Void, Void, String>() {
			...
			protected void onPostExecute(String result) {
				...
				if(JsonResolveUtils.resolveuserResult(result)){
					...
					MyPreference.getInstance(EditPassActivity.this).setUserId(uid);
					MyPreference.getInstance(EditPassActivity.this).setTelNumber(phone);
					MyPreference.getInstance(EditPassActivity.this).setPassword(etPass.getText().toString());
					MyPreference.getInstance(EditPassActivity.this).setLoginName(phoneNum);;
					MyPreference.getInstance(EditPassActivity.this).setUserSex(sex);
					MyPreference.getInstance(EditPassActivity.this).setUserName(nick);
					MyPreference.getInstance(EditPassActivity.this).setUserbirth(birth);
					//MyPreference.getInstance(RegisterActivity.this).setFact(favorite);
					MyPreference.getInstance(EditPassActivity.this).setUserPraised(praised);
					MyPreference.getInstance(EditPassActivity.this).setUserGroups(groups);
					MyPreference.getInstance(EditPassActivity.this).setUserFrinds(friends);
