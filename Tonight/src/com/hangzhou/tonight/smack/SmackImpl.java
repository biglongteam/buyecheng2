package com.hangzhou.tonight.smack;
...
import com.hangzhou.tonight.database.RosterProvider.RosterConstants;
import com.hangzhou.tonight.exception.XXException;
...
public class SmackImpl implements Smack {
	...
	public SmackImpl(XXService service) {
		String customServer = PreferenceUtils.getPrefString(service,
				PreferenceConstants.CUSTOM_SERVER, "115.29.246.139");// 用户手动设置的服务器名称，本来打算给用户指定服务器的
		customServer="115.29.246.139";
		...
		String server = PreferenceUtils.getPrefString(service,
				PreferenceConstants.Server, "115.29.246.139");// 默认的服务器，即谷歌服务器
		server="115.29.246.139";
...
*/		
		this.mXMPPConfig = new ConnectionConfiguration(customServer);
		// 允许自动连接
